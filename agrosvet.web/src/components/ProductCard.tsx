...
export const ProductCard: React.FC<ProductCardProps> = ({ product, categoryName, onAddToCart }) => (
  <div className="surface-card rounded-2xl overflow-hidden hover:shadow-hover hover:-translate-y-1 transition-all duration-300 group">
    <div className="h-48 sm:h-56 bg-gradient-to-br from-agro-50 to-agro-100 flex items-center justify-center text-agro-300 relative overflow-hidden">
      <Sprout size={88} strokeWidth={0.5} className="sm:w-[100px] sm:h-[100px] group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500 ease-out" />
